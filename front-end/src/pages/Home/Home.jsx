    ...
    <main>
      ...
      <div className="videos container mx-auto">
        <section className='flex gap-4 justify-center'>
          <article className='w-sm h-60 bg-amber-700 text-white flex justify-center items-center'>1</article>
          <article className='w-sm h-60 bg-amber-700 text-white flex justify-center items-center'>2</article>
          <article className='w-sm h-60 bg-amber-700 text-white flex justify-center items-center'>3</article>
        </section>
      </div>
      {/* discount */}
      ...
      <div className="all-products container mx-auto mt-20">
        ...
        <div className="more text-center mb-6">
          <a href="#" className="bg-blue-600 px-8 mt-6 py-2 inline-block text-white rounded-3xl">More</a>
        </div>
      </div>
    </main>
  )
